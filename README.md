...
Operations Console home experience and the resource and service topology
workspace.

The latest approved design is [Sprint 12 — resource and service topology](docs/design/sprint-12-resource-topology.md).
