...
pub use thalassa_domain::{
    ...
    HealthCheckSource, HealthSummary, ImpactDimensions, ImpactLevel, ImpactTrajectory,
    IncidentQueueItem, MetricFixture, MetricFixtureSample, MetricFixtureSource, NumberUnit,
    OperationsEvidenceRequest, OperationsSnapshot, QueueItemSourceKind, QueueStatus, RateDirection,
    ResourceScope, SignalCount, SignalSummary, SourceState, SourceStatus, StatusReason,
    ThresholdOperator, TimeWindow, WidgetDefinition, WidgetId, WidgetSize,
};
